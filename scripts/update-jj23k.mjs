...
async function update() {
  ...
  if (existing.includes(`"schemaVersion": ${schemaVersion}`) && existing.includes(`"sourceHash": "${hash}"`)) {
  ...
  const data = { schemaVersion, season, throughWeek, sourceHash: hash, careerYards, leaders };
